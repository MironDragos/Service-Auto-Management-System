...
export default function Dashboard() {
    ...
    async function getLatest(){
      ...
      const { data: completedThisMonthData, error: completedThisMonthError } = await supabase
        .from('cars_count_by_date')
        .select('*') 
      ...
      if(latestError||inProgressError||waitingError||completedThisMonthError||completedTodayError){
        ...
        setCompletedThisMonth(completedThisMonthData.map((car)=>{
          return { 
            ...car, 
